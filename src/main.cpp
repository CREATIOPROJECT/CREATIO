...
static const int64_t nTargetTimespan = 20 * 60;  // 20 minutes diff retarget
unsigned int nTargetSpacing = 1 * 60; // 1 min block-time
...
const string strMessageMagic = "Creatio Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Creatio", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "20/10/16. CREATIO";
        CTransaction txNew;
        txNew.nTime = 1476963977;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1476963977;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2511314;
		if(fTestNet)
        {
            block.nNonce   = 2511314;
        }
     	
		uint256 nhashMerkleRoot = uint256("3f7b228f1a418b32d42296ab20706ee336b8ce2d1f33e4162b17a17f80237e64");
...
unsigned char pchMessageStart[4] = { 0xd2, 0xc3, 0xa1, 0xb4 };
