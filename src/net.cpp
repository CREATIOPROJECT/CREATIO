...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Creatio " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{ "creationode1.cloudapp.net" , "creationode1.cloudapp.net" },
		{ "creationode2.cloudapp.net" , "creationode2.cloudapp.net" },
		{ "creationode3.cloudapp.net" , "creationode3.cloudapp.net" },
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Creatio is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Creatio-start");

    if (semOutbound == NULL) {
        // initialize semaphoremin
